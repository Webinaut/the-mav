...
ranking: 2.1
hero: absurd.design-chapter-1-32.png
...
<span style="float: left;width: 40%;margin:1em 2em 0 0;">
  ![Halo Effect](Halo.jpg)
</span>
Some time ago my business partner introduced me to a phenomenon he called "The
Pope Syndrome". He said that if you were seen standing next to the Pope, people
would assume that you were also a "good guy" (this may not necessarily be as
true today!). In retrospect, he was referring to the halo effect, which is a
